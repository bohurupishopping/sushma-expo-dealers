...
if (!supabaseUrl || !supabaseAnonKey) {
  throw new Error('[Supabase] Missing required environment variables: EXPO_PUBLIC_SUPABASE_URL and/or EXPO_PUBLIC_SUPABASE_ANON_KEY. Please check your environment configuration.');
}
